        ...
        Insertf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(s1.equals("")||s2.equals("")||s3.equals("")||s4.equals("")){
                    Toast.makeText(Delete.this,"Field is empty",Toast.LENGTH_LONG).show();

                }
                if (isInserted==true){
                    Toast.makeText(Delete.this,"record inserted",Toast.LENGTH_LONG).show();
                    Name.setText("");
                    Mobile.setText("");
                    Joining.setText("");
                    Payment.setText("");
                    ...
                    Toast.makeText(Delete.this,"record not inserted",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void UpdateData()
    {
        Updatef.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isUpdate==true)
                {
                    Toast.makeText(AddCust.this,"record update",Toast.LENGTH_LONG).show();
                    Name.setText("");
                    Mobile.setText("");
                    Joining.setText("");
                    Payment.setText("");
                    ...
                    Toast.makeText(AddCust.this,"record not update",Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (deletedRows>0){
                   ...
                   // Mobile.setText("");
                    ...
                    Toast.makeText(Delete.this,"record not deleted",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
